...
##### Emotecraft
!!!danger 
Эта модификация несовместима с OptiFine, вместо его используйте альтернативы, которые представлены в этом списке([тык](https://lambdaurora.dev/optifine_alternatives/ "Кликай!"))
!!!
