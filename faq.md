...
### Как долго будет рассматриваться моя заявка?
Модераторам необходимо провести ряд проверок, чтобы убедиться в том, что вы не пытаетесь обойти блокировку или не создаёте второй аккаунт. Учитывайте, что не только вы подаёте заявку, и модераторы могут не справляться с наплывом заявок.
...
Для игры на сервере необязательно устанавливать модификации и наборы ресурсов, но для лучшей коммуникации с игроками и комфортной игры желательно их установить. Список рекомендуемых модификаций можно найти [тут](https://rshape.fun/docs/mods/ "Кликай!").
